...
Calendar.prototype.style = function(){
    ...
    strStyle += ".calendar {font-size:16px; margin:0;padding:0px;border:1px solid #397EAE;background-color:#DBE7F2;}";
    ...
    strStyle += ".calendarTitle .mark{text-decoration:none;color:#000;font-family:Tahoma;font-size:20px;font-weight:normal;}";
...
Calendar.prototype.setAutoHeight = function(){
    ...
    this.iframe.style.height = 200;//height;
    this.panel.style.height = 200;//height;
...
document.write('<div id="calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#FFFFFF;font-size:16px;width:20px;height:170px;">');
document.write("<iframe id='calendarIframe' scrolling='no' frameborder='0' width='100%' height='170px'></iframe></div>");